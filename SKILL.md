...
C1.3 技术交底书（中间产物）：8章结构（发明名称→术语解释→技术领域→背景技术→发明内容→附图说明→具体实施方式→关键点和欲保护点），各章撰写要求详见 C1.5.1-C1.5.8，用于交付专利代理人。
...
按 C1.5.1-C1.5.8 逐章撰写说明书正文。脱敏规则（references/ai-patent-special.md §5）：6类通用+14行业+4项3D专项。附图（§4）：13类AI系统必备附图。
